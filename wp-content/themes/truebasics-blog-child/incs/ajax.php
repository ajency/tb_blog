...
function fetch_tag_page_articles(){
	$args = array(
		'posts_per_page' => 15,
		'post_type' => array($_POST['type']),
		'post_status' => 'publish',
...
add_action('wp_ajax_fetch_tag_page_articles', 'fetch_tag_page_articles'); 
add_action('wp_ajax_nopriv_fetch_tag_page_articles', 'fetch_category_page_articles');
